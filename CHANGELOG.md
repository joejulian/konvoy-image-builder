...
### [1.13.2](https://github.com/joejulian/konvoy-image-builder/compare/v1.13.1...v1.13.2) (2022-05-11)


### Features

* Add "dry run" build mode ([#228](https://github.com/joejulian/konvoy-image-builder/issues/228)) ([e56fdea](https://github.com/joejulian/konvoy-image-builder/commit/e56fdea37b217cb4c218ddd366fbe6bb6a203879))
...
* adds an upload artifacts command to konvoy image builder ([#214](https://github.com/joejulian/konvoy-image-builder/issues/214)) ([9ed1806](https://github.com/joejulian/konvoy-image-builder/commit/9ed18066608bf2570ce4ed76b5559d82ade78e93))
...
* allow user to run ssh communicator through bastion ([#251](https://github.com/joejulian/konvoy-image-builder/issues/251)) ([84e9674](https://github.com/joejulian/konvoy-image-builder/commit/84e967431ac9b1dc8b7563536006c8b15e574562))
* **ansible:** `list-images` use role dependencies ([e334541](https://github.com/joejulian/konvoy-image-builder/commit/e334541b05dce2fc44b8b4d467702128008d710c))
* **ansible:** split `containerd` role from `packages` ([edd3d35](https://github.com/joejulian/konvoy-image-builder/commit/edd3d353d989f31253260cfadec8c5e0503dff28))
* **ansible:** split `kubeadm` role from `packages` ([772be9b](https://github.com/joejulian/konvoy-image-builder/commit/772be9bb76eba471af32e63fd49c1a52ca02837f))
* **ansible:** split `repo` role from `packages` ([c7e961c](https://github.com/joejulian/konvoy-image-builder/commit/c7e961c764b6de0fda888695d2c5bd9b84c3ec2c))
* **azure:** add azure `--instance-type` ([f5e1940](https://github.com/joejulian/konvoy-image-builder/commit/f5e1940cfd776c5cab3c660af1c28ac17af681b3))
* **azure:** support flatcar images ([6773d1c](https://github.com/joejulian/konvoy-image-builder/commit/6773d1cf609eb6f3a6e20ef538d38b67665128b7))
* **azure:** support oracle images ([c11780a](https://github.com/joejulian/konvoy-image-builder/commit/c11780a1d9fa48089bbb8f35b483a1a9202f2612))
* **azure:** support rhel images ([cdef472](https://github.com/joejulian/konvoy-image-builder/commit/cdef4724278ce6e7860ca431d699c07cd9d565da))
* **azure:** support sles images ([49a7745](https://github.com/joejulian/konvoy-image-builder/commit/49a774523ebaab6b7a26a229330f9dea5173b7b3))
* **azure:** support ubuntu images ([91dac7f](https://github.com/joejulian/konvoy-image-builder/commit/91dac7ffc7edf6251898c96143b11a2406b34f3d))
* bulild vsphere template in air gapped environment ([#246](https://github.com/joejulian/konvoy-image-builder/issues/246)) ([5a2c62f](https://github.com/joejulian/konvoy-image-builder/commit/5a2c62f95a0293a20dda1ebfd78f7c5fcbb4915e))
...
* bump k8s to 1.22.4 ([d36a81d](https://github.com/joejulian/konvoy-image-builder/commit/d36a81dd2646e72e247ecca1aedf336bd449cb95))
...
* bump kubernetes to 1.22.8 and use the new automated repos ([809bbd9](https://github.com/joejulian/konvoy-image-builder/commit/809bbd9baf29df21e44512444da3795a8195cca6))
...
* create vsphere template image for RedHat 8.4 and 7.9 ([#239](https://github.com/joejulian/konvoy-image-builder/issues/239)) ([b5e7abe](https://github.com/joejulian/konvoy-image-builder/commit/b5e7abe50acf824e7244a8fb63440164b8ec03ac))
...
* support azure ([#230](https://github.com/joejulian/konvoy-image-builder/issues/230)) ([016481a](https://github.com/joejulian/konvoy-image-builder/commit/016481af838a878dcbfa7e7f94c5be958e35364d))
...
* use containerd with flatcar ([#300](https://github.com/joejulian/konvoy-image-builder/issues/300)) ([b96f8bc](https://github.com/joejulian/konvoy-image-builder/commit/b96f8bc65fa63cd047fe8d2ae1802005e2fe37c4))
* use published os-packages-bundles ([680d56e](https://github.com/joejulian/konvoy-image-builder/commit/680d56e9035980b47a40fc3a532c443d71db173e))
...
* adds a v1 ([ac6e72f](https://github.com/joejulian/konvoy-image-builder/commit/ac6e72fb197e73050f56b941a1f850dfe5338f0a))
...
* **ansible:** allow rsa public keys ([#271](https://github.com/joejulian/konvoy-image-builder/issues/271)) ([291e922](https://github.com/joejulian/konvoy-image-builder/commit/291e9220b843560e7c905b48dd0c1b63ca8a7ab2))
...
* **app:** remove unused `gen.go` ([8bf34b3](https://github.com/joejulian/konvoy-image-builder/commit/8bf34b35eb56e30f6226b3092bed9a5db20fba53))
* **aws:** deprecate `--aws-instance-type` ([e0dcc56](https://github.com/joejulian/konvoy-image-builder/commit/e0dcc561e0286db15ac480f55e8a3291e6e5f544))
* **azure:** always ensure image definitions ([965a769](https://github.com/joejulian/konvoy-image-builder/commit/965a769a5d0a50287576144d1d67bcee133c7b78))
* **azure:** append build name to image sku ([#326](https://github.com/joejulian/konvoy-image-builder/issues/326)) ([b921f42](https://github.com/joejulian/konvoy-image-builder/commit/b921f42a9df41a721d3a571a03a2c3c3d961d4ec))
* **azure:** fix rhel 8 build name ([9e8ec95](https://github.com/joejulian/konvoy-image-builder/commit/9e8ec952b789bb7ceb4c469c5a1b3512402d640c))
...
* cleanup vsphere VM when building vSphere template in dry run ([#283](https://github.com/joejulian/konvoy-image-builder/issues/283)) ([44b1a94](https://github.com/joejulian/konvoy-image-builder/commit/44b1a9423b34ab444d095834a4537fafe7ca10ea))
* **cmd:** add subcommads to `build` and `generate` ([4fb3798](https://github.com/joejulian/konvoy-image-builder/commit/4fb3798804ca403ae547566046a7052f6dfacdf9))
* configure NetworkManager to prevent interfering with interfaces ([#231](https://github.com/joejulian/konvoy-image-builder/issues/231)) ([36de19f](https://github.com/joejulian/konvoy-image-builder/commit/36de19f3ec5b6401240d5ee0082ae59b3efacc2c))
* create systemd drop-in to disable NetworkManager-cloud-setup service ([2f6011a](https://github.com/joejulian/konvoy-image-builder/commit/2f6011aeef8770802c5fd5db7ccb18fdda3ae1c2))
...
* **devkit:** pass `AZURE_TENANT_ID` to devkit ([94f44bc](https://github.com/joejulian/konvoy-image-builder/commit/94f44bca8b26886af8d7d303484a118270c5420f))
* disable nm-cloud-setup only for AWS provider ([9da50ce](https://github.com/joejulian/konvoy-image-builder/commit/9da50ce65525199efdf33e647f81751484fb1968))
...
* fixes version lock to set fact ([ebaba83](https://github.com/joejulian/konvoy-image-builder/commit/ebaba83028e79adf8fb295b26961a18a15e9be50))
* **flatcar:** fix no update settings ([#308](https://github.com/joejulian/konvoy-image-builder/issues/308)) ([03a618c](https://github.com/joejulian/konvoy-image-builder/commit/03a618cf8b4901fbcf66572185c55ea77094cc16))
* go-mod tidy ([7ccfaa7](https://github.com/joejulian/konvoy-image-builder/commit/7ccfaa77ee44e2ef775c8c4f2c52390fdfa57eb8))
* hardcode v3.4.x etcd version ([8d9c8e9](https://github.com/joejulian/konvoy-image-builder/commit/8d9c8e924906cf55ddbab161b410fe60eee0d804))
* have extra-vars work ([a9b962b](https://github.com/joejulian/konvoy-image-builder/commit/a9b962ba6071d68e2b45f22b43b68de1a47581ff))
...
* **lint:** don't lint CHANGELOG.md ([b8401b2](https://github.com/joejulian/konvoy-image-builder/commit/b8401b2b00d1751da70a60789daf87613c611014))
* **lint:** fix markdown rules ([b052bff](https://github.com/joejulian/konvoy-image-builder/commit/b052bff48bd215d032c364518b94d54015e0d617))
* **lint:** fix textlint rules ([731e192](https://github.com/joejulian/konvoy-image-builder/commit/731e192937f5761da0d1fda01d9b8b3f76c2cf9f))
* linting errors in changelog ([4eb2f96](https://github.com/joejulian/konvoy-image-builder/commit/4eb2f9613953743b4bb007f97ccdd81bc6acee64))
* makefile targets for NVIDIA GPU support ([#285](https://github.com/joejulian/konvoy-image-builder/issues/285)) ([b56c5af](https://github.com/joejulian/konvoy-image-builder/commit/b56c5afd51bad97844112854521a6aae8d7ff305))
* makes docs ([9d7ec72](https://github.com/joejulian/konvoy-image-builder/commit/9d7ec72f87a3ce40250344eb01c1d46b0e0dd7be))
* move goreleaser to where it really is ([82992d5](https://github.com/joejulian/konvoy-image-builder/commit/82992d53d1c1b5a75baa15f5d14120000e58b706))
...
* ova packer template ([ebcd1da](https://github.com/joejulian/konvoy-image-builder/commit/ebcd1da234e4fd8d7a13030b4b49b77ee74a093b))
* **packer:** fix spacing typo in packer template ([92fa950](https://github.com/joejulian/konvoy-image-builder/commit/92fa950a29d8694dfd83e1817b643cc4c23095f0))
* **pkg:** remove unused `config` package ([1c6509a](https://github.com/joejulian/konvoy-image-builder/commit/1c6509a97fe057b93b2d6414bb6b303df44adaea))
...
* **release:** run goreleaser on release publish ([f1218a1](https://github.com/joejulian/konvoy-image-builder/commit/f1218a13167678c7e49ebc71347eb9f4f7f869a9))
...
* remove note to add promotion job ([d9cd670](https://github.com/joejulian/konvoy-image-builder/commit/d9cd6705fe0ef14eeff9bb3d6a29c7bd4d54ca03))
...
* replace broken centos 8 appstream repo with alma linux repos ([#227](https://github.com/joejulian/konvoy-image-builder/issues/227)) ([ada2ca9](https://github.com/joejulian/konvoy-image-builder/commit/ada2ca94bfd842526a4af9878a1b67ff80e2afa3))
...
* support flatcar 3033.2.0 ([#299](https://github.com/joejulian/konvoy-image-builder/issues/299)) ([43bdfd2](https://github.com/joejulian/konvoy-image-builder/commit/43bdfd27298414130c4b3703636377c2c64fd8c7))
...
* use bastion in offline fips ova rhel builds ([#307](https://github.com/joejulian/konvoy-image-builder/issues/307)) ([8d3e338](https://github.com/joejulian/konvoy-image-builder/commit/8d3e3387779df6117e65ed98783ae1bc1194a69d))
* use crictl to pull images and supports mirrors ([#252](https://github.com/joejulian/konvoy-image-builder/issues/252)) ([f14f841](https://github.com/joejulian/konvoy-image-builder/commit/f14f841c5d325d9677349c18f5e717109e661e7f))
...
* release 1.13.2 ([97779eb](https://github.com/joejulian/konvoy-image-builder/commit/97779ebe14ad862af7b4135280540dc4fcfbc4f4))
